...
class Waypoint_navigation:
    ...
    view_distance = 6  # determines how far the drone can recognize a human, mainly influences the granularity of the search pattern
    ...
    def __init__(self, current_state, search_area_width=20, search_area_depth=20):
        ...
        self.relative_position = {"x": 0, "y": 0, "z": 0, "yaw": current_state["yaw"], "time": time.time()}
    ...
    def navigate(self, current_state):
        ...
        print("next_waypoint:"+str(self.waypoints[self.nextWaypointIndex]))
